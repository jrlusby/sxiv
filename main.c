...
{
    // I think what I need to do when I sort is remove the file from the files
    // array, decrement filecnt, reload some file from the list of files, save
    // the removed file and its destination in some list (for undo purposes)
    // that should be sufficient to move the file out of the source folder to
    // the dest folder while not breaking sxiv
